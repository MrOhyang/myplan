...
! function(e) {
	...
	i.config = function(e) {
		if (e) {
			for (var t in N) {
				...
				if (n instanceof Array) n.push.apply(n, i);
	...
	var a = e("./config"),
		...
		s = {}, l = e("zrender/tool/env").canvasSupported,
		h = new Date - 0,
		d = {}, c = "_echarts_instance_";
	s.version = "2.2.4", s.dependencies = {
		zrender: "2.0.9"
	}, s.init = function(t, n) {
		var a = e("zrender");
	...
	return t.prototype = {
		...
		add: function(e) {
			...
			"#fff" === s.style.color && (s.style.color = e.style.strokeColor), this.setCalculable(s), s.dragEnableTime = 0, o.pack(s, {
				name: a
			}, -1, i, -1, t), s = new n(s), this.shapeList.push(s), this.zr.addShape(s)
		},
		del: function(e) {
	...
	return i.prototype = {
		...
		getRect: function(e) {
			...
			s = r.getRect(r.style), t = Math.min(s.x, t), n = Math.min(s.y, n), i = Math.max(s.x + s.width, i), a = Math.max(s.y + s.height, a);
			return e.__rect = {
				x: t,
				y: n,
				width: i - t,
